...
export default async function Home() {
  ...
  reviews.forEach((review) => {
    ...
    ratingsByRestaurant[review.restaurant_id].average += Number(
      review.rating
    );
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-white/80">
              Découvrez les meilleures tables autour de vous et réservez votre
              expérience culinaire en quelques clics.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            <div className="rounded-3xl border border-[#800020]/10 bg-white p-8 shadow-sm transition duration-300 hover:shadow-lg">
              ...
              <h3 className="mt-6 text-xl font-bold">01. Découvrez</h3>
              <p className="mt-3 text-sm leading-relaxed text-gray-600">
                Parcourez une sélection de restaurants et trouvez la table
                idéale.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-[#800020]/10 bg-white p-8 shadow-sm transition duration-300 hover:shadow-lg">
              ...
              <h3 className="mt-6 text-xl font-bold">02. Réservez</h3>
              <p className="mt-3 text-sm leading-relaxed text-gray-600">
                Choisissez la date, l'heure et le nombre d'invités.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-[#800020]/10 bg-white p-8 shadow-sm transition duration-300 hover:shadow-lg">
              ...
              <h3 className="mt-6 text-xl font-bold">03. Savourez</h3>
              <p className="mt-3 text-sm leading-relaxed text-gray-600">
                Présentez-vous au restaurant et profitez de votre expérience.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-[#800020] to-[#500014] text-white">
        <div className="mx-auto max-w-4xl px-6 py-24 text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-lg text-white/80">
            Rejoignez la communauté Savora et réservez votre prochaine sortie au
